      ...
      <div className="relative z-10 flex max-lg:flex-col max-md:pt-28 lg:py-[130px]  w-full lg:w-11/12 max-w-6xl gap-14 lg:gap-6 lg:justify-between">
        <div className="flex flex-col justify-center text-white md:max-lg:items-center gap-3 sm:gap-6 lg:gap-4 max-w-4xl md:max-lg:text-center max-lg:px-6 lg:mr-10">
          ...
          <div className="flex flex-col lg:flex-row max-md:items-center  space-x-2 mt-4">
            <button className="mt-3 text-lg flex items-center gap-1 rounded-full bg-primary-500 px-5 py-3 max-md:w-2/3 max-md:justify-center max-md:text-center text-black font-semibold w-fit hover:opacity-70">
              Nuestros servicios
            </button>
